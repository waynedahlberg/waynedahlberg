    ...
    <div className="pt-8 sm:pt-20 flex-col justify-start items-start gap-5 inline-flex text-md selection:bg-amber-500 selection:text-primary px-4 sm:px-8 text-sm sm:text-base">
      ...
      <div className='text-secondary-foreground/70 leading-5 sm:leading-normal'>
        <p className="pb-4 sm:pb-4">
          THis is so huge and uneccesary, condense it and expound on the about page.
          I&apos;m Wayne Dahlberg, a software designer, coder, and tinkerer. I am also the creator of <Link href="#" className="font-medium hover:underline decoration-indigo-400 decoration-2">Super Interesting</Link> is a small studio I created for developing apps, training, and resources for software designers.</p>
