    ...
    <div className="pt-8 sm:pt-20 flex-col justify-start items-start gap-5 inline-flex text-md selection:bg-amber-500 selection:text-primary px-4 sm:px-8 text-sm sm:text-base">
      ...
      <div className='text-secondary-foreground/70 leading-5 sm:leading-normal'>
        <p className="pb-4 sm:pb-4">
          my name is Wayne Dahlberg. I am a senior software designer, coder, and creator of <Link href="#" className="font-medium hover:underline decoration-indigo-400 decoration-2">Super Interesting</Link>, a studio developing apps and resources for product designers.</p>
        <p className="pb-2 sm:pb-4">
          Previously, I was the founding team designer of <Link href="https://chatbooks.com" className="font-medium text-secondary-foreground sm:text-secondary-foreground/70 hover:underline decoration-indigo-400 decoration-2">Chatbooks</Link>, where, for more than a decade, I helped create and shape the photo book creation experience as ux, lead, and principal designer, while also architecting the <Link href="#" className="font-medium text-secondary-foreground sm:text-secondary-foreground/70 hover:underline decoration-indigo-400 decoration-2 transition-all duration-200">Breakfast</Link>, design system.
        </p>
        <p className="pb-2 sm:pb-4">
        ...
        <p className="pb-2 sm:pb-4">
          I am very passionate about building great things with great people — If this resonates with you and your team, <Link href="#" className="font-medium text-secondary-foreground sm:text-secondary-foreground/70 hover:underline decoration-indigo-4000 decoration-2">let&apos;s talk</Link>.
        </p>
        <p className="pb-2 sm:pb-4">
          Utah is our family home. The clean air fills our lungs as the mountains and red rocks loom. When the outdoors call, we answer as often as we can with a gassed-up Land Cruiser and Diet Coke all around.
        </p>
      </div>
