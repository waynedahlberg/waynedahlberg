      ...
      <div className="pt-8 sm:pt-16 flex-col justify-start items-center sm:items-start gap-5 inline-flex text-md selection:bg-amber-500 selection:text-primary px-4 sm:px-8 text-base leading-normal">
        ...
        <div className='text-secondary-foreground/60 leading-normal'>
          <p className="pb-4 sm:pb-4">
            My name is Wayne, I&apos;m a software designer from Utah. I am the creator of <Link href="https://superinteresting.co" className="font-medium hover:underline decoration-teal-400 decoration-2 text-primary">Super Interesting</Link>, a studio creating apps + resources for designers.
          </p>
          <p className="pb-4 sm:pb-4">
            Simplicity, proximity, and humanity are keys to <Link href="https://chatbooks.com" className="font-medium hover:underline decoration-teal-400 decoration-2 text-primary">my design thinking process</Link>. Experience has taught me <Link href="https://chatbooks.com" className="font-medium hover:underline decoration-teal-400 decoration-2 text-primary">code is the ultimate fidelity</Link> of software design.
          </p>
          <p className="pb-4 sm:pb-4">
            Previously, I was the founding team designer for <Link href="https://chatbooks.com" className="font-medium hover:underline decoration-teal-400 decoration-2 text-primary">Chatbooks</Link>, where I helped create and shape the photo book creation experience for nearly a decade.
          </p>
          <p className="pb-4 sm:pb-4">
            I cherish time with my family and enjoy scenic drives in the old Land Cruiser. I love shooting landscape<Link href="https://chatbooks.com" className="font-medium hover:underline decoration-teal-400 decoration-2 text-primary">  photography</Link> on film, and tinkering on a <Link href="https://chatbooks.com" className="font-medium hover:underline decoration-teal-400 decoration-2 text-primary">robot</Link> in the basement.
          </p>
        </div>
